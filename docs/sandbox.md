...
In sandbox mode, the package uses the SofizPay sandbox base URL. Service-operation requests are intercepted with Laravel's HTTP fake and receive sample responses for submission, details, and history. This is useful for local development and package tests.
